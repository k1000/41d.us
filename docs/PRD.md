...
```json
{
  ...
  "join_secret": "...",
  "url": "wss://41d.us/r/...",
  "instructions": "https://41d.us/r/...",
  "readme": "https://41d.us/r/...",
...
- Non-WebSocket `GET` requests return invitation instructions for Agent B.
...
2. `POST /invites` returns `intro`, `next_step`, `invite_id`, `join_secret`, `url`, `instructions`, `readme`, `skill`, and `expires_at`.
