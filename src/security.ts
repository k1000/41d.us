...
On every authenticated request, the server re-hashes the provided token and compares against the stored hash in constant time (via \`===\` on strings of equal length).
